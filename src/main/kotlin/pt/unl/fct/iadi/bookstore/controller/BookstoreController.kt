...
class BookstoreController(
    ...
    override fun listBooks(): ResponseEntity<List<BookResponse>> =
        ResponseEntity.ok(bookstoreService.listBooks().map(Book::toResponse))

    override fun createBook(request: CreateBookRequest): ResponseEntity<BookResponse> {
    ...
    override fun getBook(isbn: String, acceptLanguage: String?): ResponseEntity<BookResponse> =
        ResponseEntity.ok(bookstoreService.getBook(isbn).toResponse())

    override fun replaceBook(isbn: String, request: ReplaceBookRequest): ResponseEntity<BookResponse> {
    ...
    override fun updateBook(isbn: String, request: UpdateBookRequest): ResponseEntity<BookResponse> =
    ...
    override fun listReviews(isbn: String): ResponseEntity<List<ReviewResponse>> =
        ResponseEntity.ok(bookstoreService.listReviews(isbn).map(Review::toResponse))

    override fun createReview(isbn: String, request: CreateReviewRequest): ResponseEntity<ReviewResponse> {
    ...
    override fun replaceReview(isbn: String, reviewId: Long, request: ReplaceReviewRequest): ResponseEntity<ReviewResponse> =
        ResponseEntity.ok(bookstoreService.replaceReview(isbn, reviewId, request).toResponse())

    override fun updateReview(isbn: String, reviewId: Long, request: UpdateReviewRequest): ResponseEntity<ReviewResponse> =
        ResponseEntity.ok(bookstoreService.updateReview(isbn, reviewId, request).toResponse())
